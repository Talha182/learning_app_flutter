          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10.0),
                _makeForYouCard(
                    "Applied Data Science", "microsoft.png", size.width),
              ],
            ),
          ),
        ),
...
Widget _makeYourCourses(double width) {
  ...
  return Column(
    children: [
      Row(
        children: [
          _makeCourseCard("Data Science with Python",
              Colors.teal.withOpacity(0.5), cardWidth, 0.7),
          const SizedBox(width: 10.0),
          _makeCourseCard(
              "Brain Science", Colors.red.withOpacity(0.5), cardWidth, 0.4),
        ],
      ),
    ],
  );
